...
for (let a = 0; a < 5; a++) {
    ...
    for (let i = 0; i < n; i++) {
        const sphere = new ln.OutlineSphere(eye, up, position, 0.1);
        scene.add(sphere);
